...
namespace EveVoid.Migrations
{
    ...
    [Migration("20201025152512_pilot-seperation-p2")]
    partial class pilotseperationp2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EveVoid.Models.Pilots.Pilot", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EveVoid.Models.Navigation.Jump", b =>
                {
                    b.HasOne("EveVoid.Models.Pilots.Pilot", "Pilot")
                        .WithMany("Jumps")
            ...
            modelBuilder.Entity("EveVoid.Models.Pilots.MainCharacter", b =>
                {
                    b.HasOne("EveVoid.Models.EveObjects.Corporation", null)
                        .WithMany("Mains")
                        .HasForeignKey("CorporationId");
